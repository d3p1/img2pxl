...
const pixelManger = new PixelManager()
type DataSet = Array<{
  pixel: IPixel
...
const dataSet: DataSet = [
  {
    pixel: pixelManger.createPixel(1, [0, 0, 0, 0], 1, 2, 150, 150),
    expectedVelocityX: 1,
    expectedVelocityY: 2,
    expectedX: 151,
    expectedY: 152,
  ...
  {
    pixel: pixelManger.createPixel(1, [0, 0, 0, 0], 1, 2, 300, 300),
    expectedVelocityX: -1,
    expectedVelocityY: -2,
    expectedX: 299,
    expectedY: 298,
  ...
  {
    pixel: pixelManger.createPixel(1, [0, 0, 0, 0], -1, -2, -1, -1),
    expectedVelocityX: 1,
    expectedVelocityY: 2,
    expectedX: 0,
    expectedY: 1,
