        ...
        btn.on('click', () => {
            ...
            if (state.children && state.children instanceof Array) {
                ...
                const imagePixelSize =
                    imagePixel.children[0]['binding']['value']
                ...
                const imageMotionFrequency =
                    imageMotion.children[0]['binding']['value']
                const imageMotionAmplitude =
                    imageMotion.children[1]['binding']['value']
