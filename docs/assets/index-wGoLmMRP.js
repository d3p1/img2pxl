...
`)}function xE(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Hr).join(`
...
`)+`
`+d);const S=T+f+o,M=T+d+a,U=ou(r,r.VERTEX_SHADER,S),L=ou(r,r.FRAGMENT_SHADER,M);r.attachShader(b,U),r.attachShader(b,L),e.index0AttributeName!==void 0?r.bindAttribLocation(b,0,e.index0AttributeName):e.morphTargets===!0&&r.bindAttribLocation(b,0,"position"),r.linkProgram(b);function C(A){if(n.debug.checkShaderErrors){const G=r.getProgramInfoLog(b).trim(),V=r.getShaderInfoLog(U).trim(),Y=r.getShaderInfoLog(L).trim();let K=!0,X=!0;if(r.getProgramParameter(b,r.LINK_STATUS)===!1)if(K=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,b,U,L);else{const Z=lu(r,U,"vertex"),z=lu(r,L,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(b,r.VALIDATE_STATUS)+`
...
void main() {
    ...
    #include <tonemapping_fragment>
    #include <colorspace_fragment>
}`,cr,ur,Zr,Tn,sd,$a,Za,_u;let mw=(_u=class{constructor(t,e,i,r,s,o=1){Jt(this,Tn);Ne(this,"points");Jt(this,cr);Jt(this,ur);Jt(this,Zr);ce(this,ur,t),ce(this,Zr,e),ne(this,Tn,sd).call(this,i,r,s,o)}debug(){const t=Q(this,Zr).addFolder({title:"Image"});t.addBinding({resolutionWidth:this.points.geometry.parameters.widthSegments},"resolutionWidth",{min:0,max:this.points.geometry.parameters.width,step:1}).on("change",e=>{e.last&&ne(this,Tn,$a).call(this,e.value,this.points.geometry.parameters.heightSegments)}),t.addBinding({resolutionHeight:this.points.geometry.parameters.heightSegments},"resolutionHeight",{min:0,max:this.points.geometry.parameters.height,step:1}).on("change",e=>{e.last&&ne(this,Tn,$a).call(this,this.points.geometry.parameters.widthSegments,e.value)}),t.addBinding({pointSize:this.points.material.uniforms.uPointSize.value},"pointSize",{min:1,max:100,step:1}).on("change",e=>{e.last&&(this.points.material.uniforms.uPointSize.value=e.value)})}dispose(){this.points.geometry.dispose(),this.points.material.dispose(),Q(this,cr).dispose()}},cr=new WeakMap,ur=new WeakMap,Zr=new WeakMap,Tn=new WeakSet,sd=function(t,e,i,r){const s=new Gh;ce(this,cr,s.load(t));const o=ne(this,Tn,Za).call(this,e,i),a=new qn({vertexShader:pw,fragmentShader:fw,uniforms:{uImageTexture:new hn(Q(this,cr)),uPointSize:new hn(r)},transparent:!0,depthWrite:!1});this.points=new _g(o,a)},$a=function(t,e){const i=this.points.geometry.attributes;this.points.geometry.dispose(),this.points.geometry=ne(this,Tn,Za).call(this,t,e,i)},Za=function(t,e,i=null){const r=new Rr(Q(this,ur).width,Q(this,ur).height,t,e);return r.setIndex(null),r.deleteAttribute("normal"),i&&(r.attributes={...i,...r.attributes}),r},_u);var un,hr,dr,Cn,od,ad,ld,cd;class _w{constructor(t,e){Jt(this,Cn);Ne(this,"coord");Ne(this,"canvas");Ne(this,"raycaster");Ne(this,"raycasterPlane");Jt(this,un);Jt(this,hr);Jt(this,dr);this.canvas=e,this.coord=new te(void 0,void 0),ce(this,un,t),ne(this,Cn,ld).call(this)}update(){let t=null,e=null;if(this.coord.x&&this.coord.y){this.raycaster.setFromCamera(this.coord,Q(this,un).camera);const i=this.raycaster.intersectObject(this.raycasterPlane);if(i.length){const r=i[0].uv;t=r.x*this.canvas.element.width,e=(1-r.y)*this.canvas.element.height}}this.canvas.update(t,e)}debug(){this.canvas.debug()}dispose(){this.canvas.dispose(),ne(this,Cn,cd).call(this)}}un=new WeakMap,hr=new WeakMap,dr=new WeakMap,Cn=new WeakSet,od=function(t){const e=t.target;this.coord.x=(t.offsetX/e.width-.5)*2,this.coord.y=-(t.offsetY/e.height-.5)*2},ad=function(){this.coord.x=void 0,this.coord.y=void 0},ld=function(){this.raycaster=new Sg,ce(this,hr,ne(this,Cn,od).bind(this)),Q(this,un).renderer.domElement.addEventListener("pointermove",Q(this,hr)),ce(this,dr,ne(this,Cn,ad).bind(this)),Q(this,un).renderer.domElement.addEventListener("pointerleave",Q(this,dr)),this.raycasterPlane=new wn(new Rr(Q(this,un).width,Q(this,un).height),new Il),this.raycasterPlane.visible=!1},cd=function(){Q(this,un).renderer.domElement.removeEventListener("pointermove",Q(this,hr)),Q(this,un).renderer.domElement.removeEventListener("pointerleave",Q(this,dr)),this.raycasterPlane.geometry.dispose(),this.raycasterPlane.material.dispose()};var Jr,We,pr,vn,fr,Xe,ud,hd,dd,pd,Ja;class vw{constructor(t,e,i,r,s=.1,o=.05){Jt(this,Xe);Jt(this,Jr);Ne(this,"texture");Ne(this,"element");Jt(this,We);Jt(this,pr);Jt(this,vn);Jt(this,fr);ce(this,Jr,t),ce(this,fr,o),ne(this,Xe,dd).call(this,e,i),ne(this,Xe,pd).call(this,r,s)}update(t,e){ne(this,Xe,hd).call(this),t&&e&&ne(this,Xe,ud).call(this,t,e),this.texture.needsUpdate=!0}debug(){const t=Q(this,Jr).addFolder({title:"Pointer Canvas"});t.addBinding({displacementSize:Q(this,vn)/this.element.width},"displacementSize",{min:0,max:1,step:.01}).on("change",e=>ce(this,vn,this.element.width*e.value)),t.addBinding({displacementTrailingFactor:Q(this,fr)},"displacementTrailingFactor",{min:0,max:1,step:.01}).on("change",e=>ne(this,Xe,Ja).call(this,e.value)),t.addBinding({isCanvasShown:!1},"isCanvasShown").on("change",e=>{e.value?(document.body.appendChild(this.element),this.element.style.position="fixed",this.element.style.top="0",this.element.style.left="0",this.element.style.border="1px solid #fff"):document.body.removeChild(this.element)})}dispose(){this.texture.dispose()}}Jr=new WeakMap,We=new WeakMap,pr=new WeakMap,vn=new WeakMap,fr=new WeakMap,Xe=new WeakSet,ud=function(t,e){t-=Q(this,vn)/2,e-=Q(this,vn)/2,Q(this,We).save(),Q(this,We).globalCompositeOperation="lighten",Q(this,We).drawImage(Q(this,pr),t,e,Q(this,vn),Q(this,vn)),Q(this,We).restore()},hd=function(){Q(this,We).save(),Q(this,We).globalAlpha=Q(this,fr),Q(this,We).fillStyle="#000",Q(this,We).fillRect(0,0,this.element.width,this.element.height),Q(this,We).restore()},dd=function(t,e){this.element=document.createElement("canvas"),this.element.width=t,this.element.height=e,this.texture=new vg(this.element),ce(this,We,this.element.getContext("2d"))},pd=function(t,e){ce(this,pr,new Image),Q(this,pr).src=t,ne(this,Xe,Ja).call(this,e)},Ja=function(t){ce(this,vn,t*this.element.width)};const gw="/img2pxl/assets/noise-cP6mV1Be.png",xw="/img2pxl/assets/pointer-UcE5q2Bs.png";var Ti,Ci,gn,Ai,Qr,mr,Sr,fd,md;class bw{constructor(t,e,i,r,s,o=1,a=gw,l=.05,c=3,u=xw,h=.15,p=.01,m=5,g=40){Jt(this,Sr);Jt(this,Ti);Jt(this,Ci);Jt(this,gn);Jt(this,Ai);Jt(this,Qr);Jt(this,mr);ce(this,Ai,new aw),ce(this,Ti,new dw(e,i)),ne(this,Sr,md).call(this),ne(this,Sr,fd).call(this,t,r,s,o,a,l,c,u,h,p,m,g)}render(t=0){Q(this,Ai).update(t),Q(this,Ci).update(Q(this,Ai).getElapsed()),ce(this,Qr,requestAnimationFrame(this.render.bind(this)))}debug(t){t.key==="d"&&Q(this,gn).element.style.display==="none"&&(Q(this,gn).element.style.display="block",Q(this,Ci).debug())}dispose(){cancelAnimationFrame(Q(this,Qr)),window.removeEventListener("keydown",Q(this,mr)),Q(this,Ai).dispose(),Q(this,Ci).dispose()}}Ti=new WeakMap,Ci=new WeakMap,gn=new WeakMap,Ai=new WeakMap,Qr=new WeakMap,mr=new WeakMap,Sr=new WeakSet,fd=function(t,e,i,r,s,o,a,l,c,u,h,p){ce(this,Ci,new hw(new mw(Q(this,Ti),Q(this,gn),t,e,i,r),new _w(Q(this,Ti),new vw(Q(this,gn),e,i,l,c,u)),Q(this,Ti),Q(this,gn),s,o,a,h,p))},md=function(){ce(this,gn,new Y_),Q(this,gn).element.style.display="none",ce(this,mr,this.debug.bind(this)),window.addEventListener("keydown",Q(this,mr))};const _d=new bw("/img2pxl/media/images/logo.png",280,280,64,64,3);_d.render();window.addEventListener("keydown",n=>{n.key==="Escape"&&_d.dispose()});
//# sourceMappingURL=index-wGoLmMRP.js.map
